/* ─────────────────────────────────────────────────────────────────────────
   Raven Web Dashboard — pure helpers
   ...
   Loaded as a plain script before app.js (exposing window.RavenLib) and as a
...
(function (root, factory) {
    ...
    // Mirrors human_bytes() in raven/core/utils.py.
    ...
    const OBFUSCATION_SALT = "raven_obfuscation_salt";
